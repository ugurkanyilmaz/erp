...
export default function ServiceQuotesArchivePage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
      <Header title="Tamir Teklifleri Arşivi" subtitle="Gönderilmiş tamir fiyat teklifleri" IconComponent={Mail} showNew={false} showSearch={true} showBack={true} />

      <main className="w-full px-6 py-8">
        <div className="bg-white rounded-xl shadow-lg p-6">
          <div className="flex items-center justify-between mb-6">
            <h2 className="text-2xl font-bold text-slate-800">Tamir Teklifleri</h2>
          ...
          {!loading && sentQuotes.length > 0 && (
            <div className="overflow-x-auto">
              <table className="table table-zebra w-full">
                ...
                <tbody>
                  {sentQuotes
                    .filter((q) => q.quoteType === 'Service' || !q.quoteType) // Only service quotes
                    .filter((q) => {
